      ...
      <div className="flex min-h-screen">
        ...
        <div className="min-w-0 flex-1">
          <div className="sticky top-0 z-30 flex h-16 items-center border-b border-slate-200 bg-white px-4 lg:hidden">
            ...
            <p className="ml-3 font-bold text-slate-900">
          ...
          <main className="mx-auto max-w-6xl px-5 py-8 lg:px-8 lg:py-10">
            ...
            <section className="mt-6 overflow-hidden rounded-2xl bg-slate-900 shadow-sm">
              <div className="flex flex-col gap-6 p-6 sm:flex-row sm:items-center sm:justify-between lg:p-8">
                <div>
                  ...
                  <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">
                    Request a repair or maintenance service and keep your
                ...
                <button
                  ...
                  onClick={() => {
                    alert(
                      `Service request started for ${vehicle.nickname}.`
                    );
                  }}
